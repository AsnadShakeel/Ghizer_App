...
import com.ese12.gilgitapp.FurnitureModel
...
class Furniture : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sellNow.setOnClickListener {
            val ref = FirebaseDatabase.getInstance().getReference("Furniture")
            val key = ref.push().key
            val model = FurnitureModel(key!!,imgUri.toString(),etTitle.text.toString(),etManufacture.text.toString(),etDescription.text.toString(),locationClickedWord,etPrice.text.toString(),newCondition,usedCondition,yesNego,noNego,etItemColor.text.toString())
