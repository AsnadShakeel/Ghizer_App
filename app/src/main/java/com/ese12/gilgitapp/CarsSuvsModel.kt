...
var cng:Boolean=false,var millage:String="",var airBags:Boolean=false,var airConditioning:Boolean=false,var power:Boolean=false,var mirror:Boolean = false,var abs:Boolean=false,var usb:Boolean=false):Parcelable