...
class LaptopsDetails : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_laptops_details)
        val receivedData = intent.getParcelableExtra<LaptopsModel>("list")
        ...
        imageList.add(SlideModel(receivedData!!.img,""))
...
//        tvDate.text = receivedData!!.date
        ...
        if (receivedData.conditionNew == true) {
        ...
        if (receivedData.productLaptop == true) {
            tvWarranty.text = "Laptop"
        }else if (receivedData.productAccessory==true){
            tvWarranty.text = "Accessory"
        }
