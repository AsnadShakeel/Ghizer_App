...
import com.ese12.gilgitapp.selectcategory.House

class PetsDetails : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val receivedData = intent.getParcelableExtra<PetsModel>("list")
        ...
        imageList.add(SlideModel(receivedData!!.imageUri, ""))
...
//        tvDate.text = receivedData!!.date
        ...
        if (receivedData.male == true) {
            tvManufacture.text = "Male"
        }else{
            tvManufacture.text = "FeMale"
        }
        tvCondition.text=receivedData.petBreed
...
//        tvMarcha.text = receivedData.contactNumber
        ...
        tvWarranty.text = receivedData.petAge
