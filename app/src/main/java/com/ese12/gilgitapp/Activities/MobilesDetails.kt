...
class MobilesDetails : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val receivedData = intent.getParcelableExtra<MobileModels>("list")
...
//        tvDate.text = receivedData!!.date
        ...
        if (receivedData.warrantySevenDays == true) {
            tvWarranty.text = "7 Days"
        }else if (receivedData.fifDaysWar==true){
            tvWarranty.text = "15 Days"
        }else if (receivedData.thiryDaysWar==true){
