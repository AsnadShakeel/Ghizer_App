...
class CarsSuvsDetails : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cars_suvs_details)

        val receivedData = intent.getParcelableExtra<CarsSuvsModel>("list")
        ...
        imageList.add(SlideModel(receivedData!!.carImage,""))
...
//        tvDate.text = receivedData!!.date
        ...
        tvManufacture.text = receivedData.manufacturer
        ...
        if (receivedData.availableForMarchaYes == true) {
            tvMarcha.text = "Yes"
        } else {
            tvMarcha.text = "No"
        }

        if (receivedData.sevenDaysWarranty == true) {
            tvWarranty.text = "7 Days"
        }else if (receivedData.fifteenDaysWarranty==true){
            tvWarranty.text = "15 Days"
        }else if (receivedData.thirtyDaysWarranty==true){
